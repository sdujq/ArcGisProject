...
public class PhotoDrawerTemp extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		rlp2 = new LinearLayout.LayoutParams(LayoutParams.FILL_PARENT,
				LayoutParams.FILL_PARENT);
		...
		save_b.setOnClickListener(new Button.OnClickListener() {
			public void onClick(View arg0) {
				...
				try {
					/*File f = new File("XX.png");
					fos = new FileOutputStream(f);
					mBitmap.compress(Bitmap.CompressFormat.PNG, 50, fos);
					fos.flush();
					fos.close();*/
					shareBMP=mBitmap;
					PhotoDrawerTemp.this.setResult(321);
					PhotoDrawerTemp.this.finish();
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public class Pic extends View {
		...
		public Pic(Context c) {
			...
			tempBitmap = Bitmap.createBitmap(mScreenWidth, mScreenHeight,
					Bitmap.Config.ARGB_8888);
